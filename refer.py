...
class REFER:
	...
	def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
		...
		self.data['refs'] = pickle.loads(bytes(open(ref_file, 'r').read(), 'ascii'), encoding='bytes')
	...
	def createIndex(self):
		...
		for ref in self.data['refs']:
			...
			ref_id = ref[b'ref_id']
			ann_id = ref[b'ann_id']
			category_id = ref[b'category_id']
			image_id = ref[b'image_id']
			...
			# add mapping of sent
			for sent in ref[b'sentences']:
				Sents[sent[b'sent_id']] = sent
				sentToRef[sent[b'sent_id']] = ref
				sentToTokens[sent[b'sent_id']] = sent[b'tokens']
